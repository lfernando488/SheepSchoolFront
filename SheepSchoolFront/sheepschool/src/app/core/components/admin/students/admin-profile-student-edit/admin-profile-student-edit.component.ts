...
@Component({
  selector: 'app-admin-profile-student-edit',
  templateUrl: './admin-profile-student-edit.component.html',
  styleUrls: ['./admin-profile-student-edit.component.scss']
})
export class AdminProfileStudentEditComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, 
              ...
              private dialogRef: MatDialogRef<AdminProfileStudentEditComponent>,
